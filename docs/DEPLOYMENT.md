...
5. Add a GitHub Action to run `node monitor_engine.js` daily and commit the updated `data.json` (see `.github/workflows/daily-refresh.yml`).
...
5. Use Netlify Scheduled Functions or GitHub Action to refresh `data.json` (see `.github/workflows/daily-refresh.yml`).
